  ...
  return (
    <div className="space-y-4">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-2xl font-bold text-foreground">AI Intelligence Reports</h1>
        <p className="text-sm text-muted-foreground mt-1">AI-generated analysis, summaries, and risk assessments</p>
      </motion.div>
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-border/30">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
                  ...
                  <span>•</span>
                  <span className="bg-primary/10 text-primary px-1.5 py-0.5 rounded font-medium">{report.type}</span>
                </div>
              </div>
